...
static const struct of_device_id s6e8aa5x01_ams604rm01_of_match[] = {
	{ .compatible = "samsung,s6e8aa5x01-ams604rm01" }, //Galaxy J8
	{ /* sentinel */ }
};
...
MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <lucasredelive@gmail.com>"); // KuuroZero
